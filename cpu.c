...
int main(int argc, char *argv[]) {
    ...
    cpu.memory[0100] = 0742130000000; //   XOR     2,2
    cpu.memory[0101] = 0007102024713; //   MOVEAS  2,2,024713
    cpu.memory[0102] = 0003102270123; //   MOVEA   2,2,270123
    cpu.memory[0103] = 0013116000001; //   STA     2,14,1
    cpu.memory[0104] = 0012217000001; //   LDA     4,15,1
    cpu.memory[0105] = 0742130000000; //   XOR     2,2
    cpu.memory[0106] = 0600200000000; //   HLT     4
    
    printf("HALT: stop code %012lo\n", run(&cpu, 0100));
